...
class GsBocVoTacHat extends StatefulWidget {
  @override
  _GsBocVoTacHatState createState() => _GsBocVoTacHatState();
}

class _GsBocVoTacHatState extends State<GsBocVoTacHat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Giám sát tách vỏ bóc hạt'),
      ),
                    ...
                    children: [
                      const TableCell(
                        child: Padding(
                          ...
                          child: Text('Nơi bảo quản sau khi xay'),
                        ),
                      ),
                      TableCell(
                        child: TextFormField(
