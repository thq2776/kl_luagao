...
class GsRaKimLoai extends StatefulWidget {
  @override
  _GsRaKimLoaiState createState() => _GsRaKimLoaiState();
}

class _GsRaKimLoaiState extends State<GsRaKimLoai> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Giám sát rà kim loại'),
      ),
