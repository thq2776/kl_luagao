...
class GsLauBong extends StatefulWidget {
  @override
  _GsLauBongState createState() => _GsLauBongState();
}

class _GsLauBongState extends State<GsLauBong> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Giám sát xát trắng - lau bóng'),
      ),
